...
object IIETAccountsAPI {
  ...
  private val accountsHost: String = "accounts.iiet.pl"
  private val accountsBaseURL: String = "https://" + accountsHost
  ...
  private val tokenURL: String = accountsBaseURL + "/oauth/token"
  private val publicURL: String = accountsBaseURL + "/oauth/v1/public"
  private val extendedURL: String = accountsBaseURL + "/oauth/v1/extended"
